...
# Instructions
Answer the problems located inside `prob01`, `prob02`. You may do `prob03` and `prob04` as extra practice. If you have questions let your instructor or the lab assistant know. You can also consult your classmates, but please do not copy/paste code.
